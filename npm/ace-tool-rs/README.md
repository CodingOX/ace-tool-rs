...
curl -LO https://github.com/CodingOX/ace-tool-rs/releases/latest/download/ace-tool-rs_Linux_x86_64.tar.gz
curl -LO https://github.com/CodingOX/ace-tool-rs/releases/latest/download/SHA256SUMS
